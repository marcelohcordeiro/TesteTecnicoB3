...
namespace B3.Tests
{
    public class CalculoSimulacaoTituloTests
    {
        private async Task<AppDbContext> getDatabaseDbContext()
        {
            ...
            {
                databaseContext.Indexadores.Add(new Indexador { IdIndexador = 1, Descricao = "SELIC", TaxaAtual = (float)0.9, DataUltimaAtualizacao = DateTime.Now });
                databaseContext.Indexadores.Add(new Indexador { IdIndexador = 2, Descricao = "CDI", TaxaAtual = (float)0.9, DataUltimaAtualizacao = DateTime.Now });
                databaseContext.Indexadores.Add(new Indexador { IdIndexador = 3, Descricao = "IPCA", TaxaAtual = (float)0.9, DataUltimaAtualizacao = DateTime.Now });
            ...
            {
                databaseContext.descontoImpostoRendas.Add(new DescontoImpostoRenda { IdDescontoImpostoRenda = Guid.NewGuid(), Descricao = "'Até 06 meses'", QtdeMesesInicio = 0, QtdeMesesFim = 6, PercentualDesconto = (float)22.5 });
                databaseContext.descontoImpostoRendas.Add(new DescontoImpostoRenda { IdDescontoImpostoRenda = Guid.NewGuid(), Descricao = "'Até 12 meses'", QtdeMesesInicio = 7, QtdeMesesFim = 12, PercentualDesconto = (float)20 });
                databaseContext.descontoImpostoRendas.Add(new DescontoImpostoRenda { IdDescontoImpostoRenda = Guid.NewGuid(), Descricao = "'Até 24 meses'", QtdeMesesInicio = 13, QtdeMesesFim = 24, PercentualDesconto = (float)17.5 });
                databaseContext.descontoImpostoRendas.Add(new DescontoImpostoRenda { IdDescontoImpostoRenda = Guid.NewGuid(), Descricao = "'Acima de 24 meses'", QtdeMesesInicio = 25, QtdeMesesFim = null, PercentualDesconto = (float)15 });
        ...
        public async Task ShouldReturnValorLiquido()
        {
            ...
            var simulacao = await tituloService.GetSimularTitulo(new Guid("C2CCD2C3-2A9E-45A9-B407-3FDFE5D95FED"), 1000, 300, 2);

            //Assert
            Assert.Equal(1621.90, simulacao.ValorTotalLiquido, 2);
        ...
        public async Task ShouldReturnErrorWhenValorInicialEqualsZero()
        {
            ...
            Exception exception = await Record.ExceptionAsync(() => tituloService.GetSimularTitulo(new Guid("C2CCD2C3-2A9E-45A9-B407-3FDFE5D95FED"), 0, 0, 2));
        ...
        public async Task ShouldReturnErrorWhenQtdeMesesEqualsZero()
        {
            ...
            Exception exception = await Record.ExceptionAsync(() => tituloService.GetSimularTitulo(new Guid("C2CCD2C3-2A9E-45A9-B407-3FDFE5D95FED"), 1000, 0, 0));
        ...
        public async Task ShouldReturnImpostoRendaPercentualBasedOnQtdeMeses()
        {
            ...
            while (qtdMes <= 30)
            {
                ...
                //Act
                var simulacaoMes = await tituloService.GetSimularTitulo(new Guid("C2CCD2C3-2A9E-45A9-B407-3FDFE5D95FED"), 1000, 300, qtdMes);
